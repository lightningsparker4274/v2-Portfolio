...
const Zfmech = () => {
  ...
  return (
    <div className="">
      ...
      <span className="relative bottom-4">Project I</span>
      {/* Grey Box */}
        ...
        <div className="relative mt-2 bg-gray-200 rounded-md bottom-1">
          <div className="flex">
            ...
            <div className="mt-2">
              ...
              <span className="text-sm">ZFmechatronics</span>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="mt-2">
              ...
              <span className="text-sm">JAVA, FIREBASE</span>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="mt-2">
              ...
              <span className="text-sm">Ashok Leyland</span>
            </div>
          </div>
        </div>
        <span>Gallery</span>
